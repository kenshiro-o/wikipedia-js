...
function searchArticle(queryAndOptions, callback) {
    ...
    // allows false for custom urls that has no language support
    var lang = typeof queryAndOptions.lang === "undefined" ? "en" : queryAndOptions.lang;

    var summaryOnly = queryAndOptions.summaryOnly;
    var apiUrl = queryAndOptions.apiUrl || wikiConstants.WIKIPEDIA_API_URL;
    ...
    var url = wikiConstants.WIKIPEDIA_STUB + lang + apiUrl;
